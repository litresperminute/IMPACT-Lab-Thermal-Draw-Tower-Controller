...
def find_port():
    ...
    for p in ports:
        if "Arduino" in p.description or "USB Serial" in p.description or "ttyACM" in p.device or "ttyUSB" in p.device or "usbmodem" in p.device:
            return p.device
    return None
...
def main():
    ...
    log_dir = "C:\\Users\\aabdelr1\\Documents\\GitHub\\IMPACT-Lab-Thermal-Draw-Tower-Controller\\Thermal Draw Trials\\2026 Trials"
